...
public class SongController : MonoBehaviour
{
    ...
    [SerializeField] private bool realTimeSamples = true;
    [SerializeField] private bool preProcessSamples = false;

    private int displayWindowSize = 300;
    ...
    void Update()
    {
        ...
        if (realTimeSamples)
        {
            ...
            //updateBeat(realTimeSpectralFluxAnalyzer.spectralFluxSamples, getIndexFromTime(audioSource.time) / 1024);
        }
        ...
        if (preProcessSamples)
        {
            ...
            updateBeat(realTimeSpectralFluxAnalyzer.spectralFluxSamples, indexToPlot);
        }
    }
    ...
    public void updateBeat(List<SpectralFluxInfo> pointInfo, int curIndex = -1)
    {
        int numPlotted = 0;
        int windowStart = 0;
        int windowEnd = 0;
